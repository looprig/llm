...
func TestOpenCodeSessionHeaderContract(t *testing.T) {
	t.Parallel()
	contracttest.SessionHeader(t, llm.ProviderOpenCodeGo, auth.APIKey("key"), "x-opencode-session", func(selected model.Model, key auth.APIKey, options ...simple.Option) (inference.Client, error) {
