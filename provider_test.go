...
func TestOpenCodeProviderMatrixIsClassified(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "gmi cloud", provider: llm.Provider("gmicloud"), apiFormats: []model.APIFormat{model.APIFormatOpenAI}, authKind: auth.AuthAPIKey},
		...
		{name: "llama", provider: llm.Provider("llama"), apiFormats: []model.APIFormat{model.APIFormatOpenAI}, authKind: auth.AuthAPIKey},
		{name: "llama.cpp", provider: llm.Provider("llama.cpp"), apiFormats: []model.APIFormat{model.APIFormatOpenAI}, authKind: auth.AuthNone},
